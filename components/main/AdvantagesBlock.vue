<template>
  <section class="advantages">
    <div class="container">
      <div class="advantages__header d-flex flex-column justify-content-center">
        <h2 class="header__title">Designing Better Experience</h2>
        <p class="header__description">Problems trying to resolve the conflict between the two major realms of Classical
          physics: Newtonian mechanics </p>
      </div>
      <div class="advantages__list row">
        <div class="advantages__column col-12 col-sm-6 col-lg-3 d-flex justify-content-center"
          v-for="item in advantagesList" :key="item.text">
          <div class="advantages__item item-advantages d-flex flex-column align-items-center">
            <div class="item-advantages__icon d-flex justify-content-center align-items-center">
              <img :src="require(`@/assets/img/${item.icon}.svg`)" :alt="item.text" />
            </div>
